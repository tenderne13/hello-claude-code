...
// Polyfill for build-time macros (MACRO is injected at build time via bun:bundle,
// but in dev mode we need to provide a runtime fallback).
...
// Polyfill for feature flags (always false in dev/decompiled build)
// eslint-disable-next-line custom-rules/no-top-level-side-effects
